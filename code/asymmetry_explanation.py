...
print("\n" + "="*60)
print("WHY IS THE LEFT SIDE HIGHER THAN THE RIGHT?")
print("="*60)
print("\nAt x = 0.25 (left peak):")
print(f"  ψ₁ = {psi_1[250]:+.3f}")
print(f"  ψ₂ = {psi_2[250]:+.3f}")
print(f"  Both are POSITIVE → they ADD UP")
print(f"  Sum = {psi_super[250]:+.3f}")
print(f"  Probability = {prob_super[250]:.3f}")

print("\nAt x = 0.75 (right peak):")
print(f"  ψ₁ = {psi_1[750]:+.3f}")
print(f"  ψ₂ = {psi_2[750]:+.3f}")
print(f"  OPPOSITE SIGNS → they CANCEL")
print(f"  Sum = {psi_super[750]:+.3f}")
print(f"  Probability = {prob_super[750]:.3f}")

print("\n" + "="*60)
print("This is QUANTUM INTERFERENCE!")
print("- Constructive interference on LEFT → higher probability")
print("- Destructive interference on RIGHT → lower probability")
print("="*60)